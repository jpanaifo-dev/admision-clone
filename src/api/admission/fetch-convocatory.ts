...
// export async function createConvocatory(convocatoryData: Partial<IConvocatory>) {
//   try {
//     const response = await post(URL_ADMISSION_CONVOCATORY, convocatoryData, 'admission');
//     console.log("Esta es la url de la api: ", URL_ADMISSION_CONVOCATORY)
//     console.log("estos son los datos que se envian: ", convocatoryData)
